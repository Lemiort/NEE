...
/*        char* vertexShaderSorceCode=ReadFile("Shaders/particle.vsh");
    ...
    m_deltaTimeMillisLocation = glGetUniformLocation(shaderProgramID,"gDeltaTimeMillis");
    m_randomTextureLocation = glGetUniformLocation(shaderProgramID,"gRandomTexture");
    m_timeLocation = glGetUniformLocation(shaderProgramID,"gTime");
    m_launcherLifetimeLocation = glGetUniformLocation(shaderProgramID,"gLauncherLifetime");
    m_shellLifetimeLocation = glGetUniformLocation(shaderProgramID,"gShellLifetime");
    m_secondaryShellLifetimeLocation = glGetUniformLocation(shaderProgramID,"gSecondaryShellLifetime");
...
void ParticleUpdateAssistant::Enable()
{
