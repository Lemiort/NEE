...
//         if (Success == 0) {
//                 glGetProgramInfoLog(shaderID, sizeof(ErrorLog), NULL,
//                 ErrorLog); fprintf(stderr, "Error linking shader program:
//                 '%s'\n", ErrorLog);
// 				fprintf(flog, "Error linking shader program: '%s'\n",
// ErrorLog); 				fclose(flog); 				exit(1);
//         }
...
// 		return shaderID;
// 	}
// GLuint MakeShaderProgram(GLuint vertexShaderID,GLuint geometryShaderID,GLuint
// fragmentShaderID)
// 	{
// 		FILE* flog;
// 		//fopen_s(&flog,"shaderbuild.log","w");
